...
public class Castle2 extends GameObject implements EntityCastle{
	...
	public Castle2(double x, double y, Textures tex, Controller controller, Game game)
	{
		super(x, y);
		this.tex = tex;
		...
		anim = new Animation(3 , tex.castle2[0], tex.castle2[1]);
	}
	public void tick() {
		for(int i = 0; i < game.ea.size(); i++) {
			EntityCastle tempEnt = game.ea.get(i); // 아직 구현중
		}
